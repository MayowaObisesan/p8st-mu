    ...
    <Home>
      <section>
        ...
        <section className="bg-base-300 lg:bg-base-200 rounded-xl lg:rounded-3xl px-4 pb-4">
          <Card isFooterBlurred radius="lg" className="hidden border-none">
            <Image
              ...
              width={200}
            />
            <CardFooter className="flex flex-col gap-y-2 h-[calc(100%_-_8px)] justify-between before:bg-white/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
          ...
          <section className="hidden relative flex flex-row px-2 py-12">
            <div className="flex-1">
              <div className="flex flex-row items-center px-2 lg:px-6 text-xl text-base-content/20">
                <span className="flex-1 flex flex-row items-center gap-4">
                  <LucideWallet /> Address:
          ...
          {activeAddress && walletStatus === "connected" ? (
            <section className="hidden flex flex-row flex-wrap justify-around lg:justify-start gap-2 lg:space-x-8 mb-4 *:flex-1 lg:*:flex-0">
              {/* Financial Transactions */}
              <DepositTransaction />
              <TransferTransaction />
              <WithDrawTransaction />

    ...
    try {
      ...
      if (isAvailable) {
        ...
        if (
          signedAllocatorAddress ===
            "0x19a567b3b212a5b35bA0E3B600FbEd5c2eE9083d" &&
          signedValidatorAddress === validatorAddress
        ) {
          setCoinbaseVerified(!coinbaseVerified);
          toast.success("Finance Identity verified successfully");
          toast("You can proceed create to make your transfer");
        }
    ...
    <Home>
      <section>
        ...
        <section className="bg-base-300 lg:bg-base-200 rounded-xl lg:rounded-3xl px-4 pb-4">
          ...
          {activeAddress && walletStatus === "connected" && coinbaseVerified ? (
            <section className="flex flex-row flex-wrap justify-around lg:justify-start gap-2 lg:space-x-8 mb-4 *:flex-1 lg:*:flex-0">
              {/* Financial Transactions */}
              <DepositTransaction />
              <TransferTransaction />
